...
import { getFollowersApi, followUserApi, unfollowUserApi } from "../../../src/services/follow.api";
...
export default function FollowersScreen() {
  ...
  const load = useCallback(async () => {
    ...
    setIsLoading(true);
    try {
      const result = await getFollowersApi(id, { limit: PAGE_SIZE });
  ...
  const loadMore = useCallback(async () => {
    ...
    setLoadingMore(true);
    try {
      const result = await getFollowersApi(id, { cursor, limit: PAGE_SIZE });
